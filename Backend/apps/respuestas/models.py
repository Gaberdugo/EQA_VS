...
class Encuesta(models.Model):
    ...
    documento_estudiante = models.CharField(max_length=20, unique=False, null=True, blank=True)  # Documento de identidad del estudiante
    grado = models.CharField(max_length=50)  # Grado
    edad = models.IntegerField()  # Edad
    genero = models.CharField(max_length=255, null=True, blank=True) # Genero
    fecha_cargue = models.CharField(max_length=100, null=True, blank=True)
