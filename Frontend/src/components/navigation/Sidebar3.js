...
function Sidebar3(){
  ...
  const navigation = [
      ...
      { name: 'Reporte G', href: '/reportPage', icon: ChartBarIcon, current: location.pathname==='/reportPage' ? true:false },
      { name: 'Reporte 1', href: '/reportPage1', icon: DocumentReportIcon, current: location.pathname==='/reportPage1' ? true:false },
      { name: 'Reporte 2', href: '/reportPage2', icon: DocumentReportIcon, current: location.pathname==='/reportPage2' ? true:false },
